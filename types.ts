...
export const TRANSLATIONS: Record<Language, Translation> = {
  TR: {
    ...
    sfxVol: "Oyun Sesi",
    help: "Yardım",
    helpTitle: "Uzay Yolculuğu Rehberi",
    helpText: "Yeni gezegenlere ulaşmak için şu adımları izle:\n\n1. 🏙️ Nüfusunu Artır: Mars için 500, Venüs için 2000, Jüpiter için 5000 nüfusa ulaş.\n2. 🛒 Marketten Parça Al: Market > Uzay Programı sekmesinden roket parçalarını satın al.\n3. 🚀 Roketi Tamamla: 16. slottaki (sağ alt) roket rampasında inşaatı tamamla.\n4. 🌌 Fırlat: Roket hazırken üzerine tıkla ve uzaya açıl!",
